...
func (r *BookingRepo) ListBookingsInRange(ctx context.Context, q repository.Querier, userID string, from, to repository.AppTime) ([]app.Booking, error) {
...
func (r *BookingRepo) ListBookings(ctx context.Context, q repository.Querier, userID string, from, to repository.AppTime, filtered bool) ([]app.Booking, error) {
	var (
		rows pgx.Rows
		err  error
	)
...
func (r *BookingRepo) InsertBooking(ctx context.Context, q repository.Querier, b *app.Booking) (string, error) {
